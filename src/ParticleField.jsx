...
function Scene({ tier, reduced, bloomEnabled }) {
  ...
  return (
    <>
      ...
      {/* The visible black hole itself is the standalone raw-WebGL raymarcher
          (BlackHole.jsx), layered on top of this canvas in the DOM. BLACK_HOLE
          here still drives the invisible gravity well pulling nearby network
          nodes toward it. */}
